...
class AdokitViewController: UIViewController, UITextFieldDelegate {
    ...
    let allItems: [String] = ["Kebbeh Krass (6pcs)","Kebbeh halabiyeh (12 pcs)","Kebbeh Zghertawieh (6pcs)","Kebbit Awarma & Labaneh (6pcs)","Kebbit samak (12pcs)","Kebbit djej (12pcs)","Kebbit Are3 (pumpkin) (12pcs)","Sambousik (12pcs)","Rkakat (cheese rolls) (12pcs)","Makanek (sausages) 500G","Soujouk 500G","Keshek 500G","Awarma 500G","Goat Labaneh 500g","Warak 3enab 500G","Four cheese","Pizza","Chicken cheese","Beef cheese","Cheddar Hotdog","Olive-Thym cheese","Banana cinnamon (caramelized)","Straw-cranberry dark chocolate Combo"]
    
    let allSections: Array<String> = ["Mouneh","Healthy Retail Groceries","Rollies (flavoured Rkakat) 8 pcs"]

    let allPrices: [Int] = [14000,12000,20000,20000,12000,12000,24000,9000,8000,15000,12500,18000,20000,9000,10000,12000,12000,12000,12000,12000,12000,12000,12000]
    ...
    override func viewDidLoad() {
        ...
        sectionTitleArray  = ["Mouneh","Healthy Retail Groceries","Rollies (flavoured Rkakat) 8 pcs"]

        let tmp1: NSArray = ["Kebbeh Krass (6pcs)","Kebbeh halabiyeh (12 pcs)","Kebbeh Zghertawieh (6pcs)","Kebbit Awarma & Labaneh (6pcs)","Kebbit samak (12pcs)","Kebbit djej (12pcs)","Kebbit Are3 (pumpkin) (12pcs)"]
        let tmp2: NSArray = ["Sambousik (12pcs)","Rkakat (cheese rolls) (12pcs)","Makanek (sausages) 500G","Soujouk 500G","Keshek 500G","Awarma 500G","Goat Labaneh 500g","Warak 3enab 500G"]
        let tmp3: NSArray = ["Four cheese","Pizza","Chicken cheese","Beef cheese","Cheddar Hotdog","Olive-Thym cheese","Banana cinnamon (caramelized)","Straw-cranberry dark chocolate Combo"]
        
        let tmp1Prices: NSArray = [14000,12000,20000,20000,12000,12000,24000]
        let tmp2Prices: NSArray = [9000,8000,15000,12500,18000,20000,9000,10000]
        let tmp3Prices: NSArray = [12000,12000,12000,12000,12000,12000,12000,12000]
    ...
    @IBAction func confirmButton(sender: AnyObject) {
        ...
        NSUserDefaults.standardUserDefaults().setObject("Adokit", forKey: "restoName")
