...
class CharboulViewController: UIViewController, UITextFieldDelegate {
    ...
    let allItems: [String] = ["Lahme","Tawouk","Kabab","Tawouk  Special","Steak","Steak Special","Asabit Djej","Makanek","Soujouk","Hamburger","Cheese Burger","Chicken  Burger","Fajita","Philadelphia","Rosto","Hot  Dog","Hot Dog Special","Nkha3at","Sanesil","Batata","Kafta Naye","Habra Naye","Shawarma Lahme","Shawarma Djej","Lsenet","Djej","Lahme Plate","Tawouk Plate","Tawouk Plate","Tawouk Special Plate","Steak Plate","Steak  Special Plate","Asabit Djej Plate","Makanek Plate","Soujouk Plate","Hamburger Plate","Cheese Burger Plate","Chicken Burger Plate","Fajita Plate","Philadelphia Plate","Rosto Plate","Hot Dog Plate","Hot Dog  Special Plate","Nkha3at Plate","Sanesil Plate","Batata Plate","Kafte Naye Plate","Habra Naye Plate","Shawarma  Lahme Plate","Shawarma Djej Plate","Lsenet Plate","Djej Plate","Water small","Water big","Pepsi","Mirinda","7-up","Beer"]

    let allSections: Array<String> = ["Sandwiches","Plates","Cold Beverages"]
    let allPrices: [Int] = [5000,4000,4000,5000,4000,5000,4000,4000,4000,4000,5000,4000,5000,5000,4000,4000,5000,5000,5000,3000,4000,4000,4000,4000,5000,4000,7000,6000,6000,7000,6000,7000,6000,6000,6000,6000,7000,6000,7000,7000,6000,6000,7000,7000,7000,5000,5000,5000,6000,4000,7000,6000,500,1000,1000,1000,1000,2000]
    ...
    override func viewDidLoad() {
        ...
        sectionTitleArray  = ["Sandwiches","Plates","Cold Beverages"]
        
        let tmp1: NSArray = ["Lahme","Tawouk","Kabab","Tawouk  Special","Steak","Steak Special","Asabit Djej","Makanek","Soujouk","Hamburger","Cheese Burger","Chicken  Burger","Fajita","Philadelphia","Rosto","Hot  Dog","Hot Dog Special","Nkha3at","Sanesil","Batata","Kafta Naye","Habra Naye","Shawarma Lahme","Shawarma Djej","Lsenet","Djej"]
        let tmp2: NSArray = ["Lahme Plate","Tawouk Plate","Tawouk Plate","Tawouk Special Plate","Steak Plate","Steak  Special Plate","Asabit Djej Plate","Makanek Plate","Soujouk Plate","Hamburger Plate","Cheese Burger Plate","Chicken Burger Plate","Fajita Plate","Philadelphia Plate","Rosto Plate","Hot Dog Plate","Hot Dog  Special Plate","Nkha3at Plate","Sanesil Plate","Batata Plate","Kafte Naye Plate","Habra Naye Plate","Shawarma  Lahme Plate","Shawarma Djej Plate","Lsenet Plate","Djej Plate"]
        let tmp3: NSArray = ["Water small","Water big","Pepsi","Mirinda","7-up","Beer"]
        
        let tmp1Prices: NSArray = [5000,4000,4000,5000,4000,5000,4000,4000,4000,4000,5000,4000,5000,5000,4000,4000,5000,5000,5000,3000,4000,4000,4000,4000,5000,4000]
        let tmp2Prices: NSArray = [7000,6000,6000,7000,6000,7000,6000,6000,6000,6000,7000,6000,7000,7000,6000,6000,7000,7000,7000,5000,5000,5000,6000,4000,7000,6000]
        let tmp3Prices: NSArray = [500,1000,1000,1000,1000,2000]
    ...
    @IBAction func confirmButton(sender: AnyObject) {
        ...
        NSUserDefaults.standardUserDefaults().setObject("Snack Charboul", forKey: "restoName")
