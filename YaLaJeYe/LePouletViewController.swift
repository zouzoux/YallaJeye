...
class LePouletViewController: UIViewController, UITextFieldDelegate {
    ...
    var checkStatus = [false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false]
    
    let allItems: [String] = ["Season  Salad","Rocca Salad","Chicken Salad","Coleslaw Salad","Tuna Salad","Fattouch","Fattouch (large)","French Fries (plate)","French Fries (large)","French Fries (box)","Broasted Potatoes","Hommos","Moutabal","Shish Tawouk","Shish Tawouk Platter","Lahme (lamb meat)","Kabab","Chicken","Steak","Fish Filet","Hamburger","Cheese Burger","Chicken Burger","Falafel","Makanek","Soujouk","Shawarma Lahme","Shawarma djej","Shawarma Lahme (large)","Shawarma Djej (large)","Shawarma Lahme (Saj bread)","Shawarma Djej (Saj bread)","Chicken Liver","Fajita","Crispy","Rosto","Grilled Chicken","½ Grilled Chicken","Grilled Chicken Special","Chicken","Drumsticks (10 pcs)","Legs (8 pcs)","Wings( 12 pcs )","Chicken Filet (light)","Meat Filet (light","Fish Filet (light)","Shawarma Djej","Shawarma Lahme","Shawarma Lahme","Legs (8 pcs)","Wings (12 pcs)","Wings With Coriander (12 pcs)","1 Kg Lahme Che2af","1 Kg Tawouk","1 Kg Kabab","1 Kg Machewe Mchakal","Jello","Custard","Laban 3iran","Water small","Water big","Pepsi","7-up","Mirinda","Pepsi (1.25 L)","7-Up (1.25 L)","Mirinda (1,25 L)","Pepsi (2L)","7-Up (2L)","Mirinda (2L)"]
    let allSections: Array<String> = ["Salads","Potatoes","Starters","Sandwich 3al fahem","Farrouj ghaz","Broasted chicken","Platters","Djej 3al fahem","Machewe","Dessert & Beverages"]

    let allPrices: [Int] = [6000,7000,9000,5000,8000,8000,13000,4000,7000,3000,8000,5000,5000,5000,7000,5000,4000,4000,5000,5000,4000,5000,5000,2500,4000,4000,4000,3000,6000,5000,7000,6000,5000,5000,5000,4000,13000,7000,15000,18000,20000,18000,14000,16000,18000,14000,10000,10000,15000,15000,14000,18000,40000,30000,35000,35000,3000,3000,1000,500,1000,1000,1000,1000,2000,2000,2000,2500,2500,2500]
    ...
    override func viewDidLoad() {
        ...
        sectionTitleArray  = ["Salads","Potatoes","Starters","Sandwich 3al fahem","Farrouj ghaz","Broasted chicken","Platters","Djej 3al fahem","Machewe","Dessert & Beverages"]
        let tmp1: NSArray = ["Season  Salad","Rocca Salad","Chicken Salad","Coleslaw Salad","Tuna Salad","Fattouch","Fattouch (large)"]
        let tmp2: NSArray = ["French Fries (plate)","French Fries (large)","French Fries (box)","Broasted Potatoes"]
        let tmp3: NSArray = ["Hommos","Moutabal"]
        let tmp4: NSArray = ["Shish Tawouk","Shish Tawouk Platter","Lahme (lamb meat)","Kabab","Chicken","Steak","Fish Filet","Hamburger","Cheese Burger","Chicken Burger","Falafel","Makanek","Soujouk","Shawarma Lahme","Shawarma djej","Shawarma Lahme (large)","Shawarma Djej (large)","Shawarma Lahme (Saj bread)","Shawarma Djej (Saj bread)","Chicken Liver","Fajita","Crispy","Rosto"]
        let tmp5: NSArray = ["Grilled Chicken","½ Grilled Chicken","Grilled Chicken Special"]
        let tmp6: NSArray = ["Chicken","Drumsticks (10 pcs)","Legs (8 pcs)","Wings( 12 pcs )"]
        let tmp7: NSArray = ["Chicken Filet (light)","Meat Filet (light)","Fish Filet (light)","Shawarma Djej","Shawarma Lahme"]
        let tmp8: NSArray = ["Shawarma Lahme","Legs (8 pcs)","Wings (12 pcs)","Wings With Coriander (12 pcs)"]
        let tmp9: NSArray = ["1 Kg Lahme Che2af","1 Kg Tawouk","1 Kg Kabab","1 Kg Machewe Mchakal"]
        let tmp10: NSArray = ["Jello","Custard","Laban 3iran","Water small","Water big","Pepsi","7-up","Mirinda","Pepsi (1.25 L)","7-Up (1.25 L)","Mirinda (1,25 L)","Pepsi (2L)","7-Up (2L)","Mirinda (2L)"]
        
        
        
        let tmp1Prices: NSArray = [6000,7000,9000,5000,8000,8000,13000]
        let tmp2Prices: NSArray = [4000,7000,3000,8000]
        let tmp3Prices: NSArray = [5000,5000]
        let tmp4Prices: NSArray = [5000,7000,5000,4000,4000,5000,5000,4000,5000,5000,2500,4000,4000,4000,3000,6000,5000,7000,6000,5000,5000,5000,4000]
        let tmp5Prices: NSArray = [13000,7000,15000]
        let tmp6Prices: NSArray = [18000,20000,18000,14000]
        let tmp7Prices: NSArray = [16000,18000,14000,10000,10000]
        let tmp8Prices: NSArray = [15000,15000,14000,18000]
        let tmp9Prices: NSArray = [40000,30000,35000,35000]
        let tmp10Prices: NSArray = [3000,3000,1000,500,1000,1000,1000,1000,2000,2000,2000,2500,2500,2500]
        print(tmp1.count)
    ...
    @IBAction func confirmButton(sender: AnyObject) {
        ...
        NSUserDefaults.standardUserDefaults().setObject("Le Poulet", forKey: "restoName")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> CustomDipNDipCellTableViewCell{
        ...
        if indexPath.section == 3 && indexPath.row == 13{
        ...
        if indexPath.section == 3 && indexPath.row == 14{
        ...
        if indexPath.section == 3 && indexPath.row == 15{
        ...
        if indexPath.section == 3 && indexPath.row == 16{
        ...
        if indexPath.section == 3 && indexPath.row == 17{
        ...
        if indexPath.section == 3 && indexPath.row == 18{
        ...
        if indexPath.section == 3 && indexPath.row == 19{
        ...
        if indexPath.section == 3 && indexPath.row == 20{
        ...
        if indexPath.section == 3 && indexPath.row == 21{
        ...
        if indexPath.section == 3 && indexPath.row == 22{
