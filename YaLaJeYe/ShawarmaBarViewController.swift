//
//  ShawarmaBarViewController.swift
//  YallaJeye
//
...
class ShawarmaBarViewController: UIViewController, UITextFieldDelegate {
    ...
    let allItems: [String] = ["Chicky Shawarma","Juicy Beef  Shawarma","Beef Shawarma Bar","Shawarma Bites(Beef or chicken-10 pcs)","Shawarma Soujouk","2 Sandwiches of your choice","Chicken(500g)","Beef(500g)","Pepsi","7-up","Mirinda","Water small"]
    let allSections: Array<String> = ["Shawarma","Our special combo","Soft drinks"]
    let allPrices: [Int] = [3500,4000,4000,13000,4000,9000,15000,18000,1000,1000,1000,750]
    ...
    override func viewDidLoad() {
        ...
        sectionTitleArray  = ["Shawarma","Our special combo","Soft drinks"]
        let tmp1: NSArray = ["Chicky Shawarma","Juicy Beef  Shawarma","Beef Shawarma Bar","Shawarma Bites(Beef or chicken-10 pcs)","Shawarma Soujouk"]
        let tmp2: NSArray = ["2 Sandwiches of your choice","Chicken(500g)","Beef(500g)"]
        let tmp3: NSArray = ["Pepsi","7-up","Mirinda","Water small"]
        
        let tmp1Prices: NSArray = [3500,4000,4000,13000,4000]
        let tmp2Prices: NSArray = [9000,15000,18000]
        let tmp3Prices: NSArray = [1000,1000,1000,750]
        print(tmp1.count)
    ...
    @IBAction func confirmButton(sender: AnyObject) {
        ...
        NSUserDefaults.standardUserDefaults().setObject("Shawarma Bar", forKey: "restoName")
